...
Provide here understandable summary of findings for clinicians and PIs.

# SAP and/or study protocol version

This report is based on SAP version XXX and/or study protocol version YYY.
...
Describe the methods, ideally in a form that can be used directly in a paper. Statistical software used.
...
This report is based on SVN version control XX (adress).
